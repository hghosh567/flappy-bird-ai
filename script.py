...
PIPE1 = pygame.transform.scale2x(pygame.image.load(os.path.join("imgs","pipe.png")))
PIPE = pygame.transform.scale(PIPE1,(100,640))
...
STAT_FONT = pygame.font.SysFont("comicans",60)
class Bird:
